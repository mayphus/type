...
(define (footer locale current-path)
  `(footer ((class "rime-footer"))
           (div ((class "rime-footer-meta"))
                (nav ((class "rime-footer-links") (aria-label "Project links"))
                     (a ((href "https://github.com/mayphus/input-foundry")) "GitHub")
                     (a ((href "https://zh.mayphus.org")) "zh.mayphus.org"))
