...
(define shuffle17-button-specs
  (list
   ...
   (shuffle-spec "oxvButton" "e" "X" "uai uan" "*" "o" "v" (char-action "*") #f 19)
   (shuffle-spec "smButton" "f" "M S" "ie uo" "#" "" "" (char-action "#") #f 18)
   ...
   (shuffle-spec "wzButton" "j" "W Z" "e" "0" "" "" (char-action "0") #f 18)
